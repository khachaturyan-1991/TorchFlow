...
class UNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.up_l2 = UpperBlockCustom(nn.ConvTranspose2d, 128 + 128, 64)
        self.up_l1 = UpperBlockCustom(nn.ConvTranspose2d, 64 + 64, 1)
...
class UNetZeroDecoder(nn.Module):

    def __init__(self, **kwargs):
        super(UNetZeroDecoder, self).__init__(**kwargs)
        self.down_l1 = DownBlock(in_channels=1,
                                 out_channels=64)
        self.down_l2 = DownBlock(in_channels=64,
                                 out_channels=128)
        ...
        self.up_l2 = UpperBlockCustom(CustomConvTranspose2d, 128 + 128, 64)
        self.up_l1 = UpperBlockCustom(CustomConvTranspose2d, 64 + 64, 1)
...
if __name__ == "__main__":
    ...
    Y = model(X)
    print("UNetZeroDecoder output shape: ", Y.shape)
